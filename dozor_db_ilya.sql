...
(2, 'Тестовая игра', 'not_started', NULL, NULL);
...
(1, 10001, 'simsim_pro__', '2025-09-03 04:40:57'),
(2, 10002, 'Ilyakrut9', '2025-09-03 04:40:57'),
...
(25, 2, 1, 'Мост на Гвардейской', 'В жизни Шурика бывало разное: например, нужно найти контрагента с дебиторской задолженностью (1660218703). И вот он мчится по этому адресу, слушая песню RHCP:\r\n«Sometimes I feel\r\nLike I don\'t have a partner…»\r\nКод опасности 2, метки. На брифе вы получили конфету. Это бонус на всю игру. Дерзайте.', 'CODE1 _ 1', 'CODE1 _ 2', 'CODE1'),
(26, 2, 2, 'КФЭИ', 'Альма-матер Шурика использовалась им всегда для подтягивания икроножных мышц. Фантазируя над картой, Шурик загадывал бы это место как точку схождения американских подпольных спиртных дел мастеров. Вдобавок шифровались они шифровались и меняли форматы. Код опасности 1. Пароль: период дат без тире', 'CODE2 _ 1', 'CODE2 _ 2', 'CODE2'),
(27, 2, 3, 'Лаванда', 'Используйте реквизит. Код опасности 1. Ожидают агенты.', 'CODE3 _ 1', 'CODE3 _ 2', 'CODE3'),
(28, 2, 4, 'Дубравный лес', 'Шурик хотел вернуться в прошлое. Пересмотрев «Назад в будущее», он решил, что для начала ему нужно место, в которое чаще всего бьют молнии. Чаще всего скопление их притягивает молнии. Шурик знал это место ещё по игре «Незваный гость» от KiCaDa, состоявшейся 16 декабря 2006 года. Код опасности 1, метки.', 'CODE4 _ 1', 'CODE4 _ 2', 'CODE4'),
(29, 2, 5, 'Озеро Кабан', 'Одним из новых приключений Шурика была съёмка в фильме 2013 года и дружба с Гошей К. «О. К. тогда, – сказал себе Шурик, – всё равно надо вставить туда любимую песню:\r\n«Постой, паровоз, не стучите колёса,\r\nКондуктор, нажми на тормоза,\r\nЯ к маменьке родной с последним приветом…»\r\nКод опасности 2, метки.', 'CODE5 _ 1', 'CODE5 _ 2', 'CODE5'),
(30, 2, 6, 'Аракчино, 43 артиллерийская база', 'В армии Шурик не служил, хотя иногда и подумывал об этом. Финансисту-оценщику нашлось бы место на какой-нибудь основе, фундаменте. Но часть выбрал бы себе обязательно с красивым номером, как у родного региона. Код опасности 2, метки.', 'CODE6 _ 1', 'CODE6 _ 2', 'CODE6'),
(31, 2, 7, 'Пляж Локомотив', 'Хорошая девочка Лида… Шурик не был святым или протопопом, и ему точно она была нужна утром. Однако в это время было не просто отсутствие, а вавуум. Да ещё и сосед Хасаныч своими археологическими историями их отпугивал напрочь. Код опасности 1. Задание делать последним. Ожидают агенты.', 'CODE7 _ 1', 'CODE7 _ 2', 'CODE7');
